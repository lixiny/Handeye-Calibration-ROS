...
This results is optimized only based on RGB images. You can still fine-tune the result with depth image (if has) following the instruction in`master` branch.
