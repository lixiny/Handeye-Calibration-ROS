    ...
    else
    {
        ...
        else
        {
            ...
            if(initSuccessful)
            {
                ...
                // }
                _tmp_rgb_image = cvCreateImage(cvSize(640, 480), IPL_DEPTH_8U, 3); 
                _rgb_image = cvCreateImage(cvSize(640, 480), IPL_DEPTH_8U, 3);
                _depth_image = cvCreateImage(cvSize(640, 480), IPL_DEPTH_16U, 1); 
                ...
                setAutoExposure(cameraAutoExposure);
                setAutoWhiteBalance(cameraAutoWhiteBalance);
