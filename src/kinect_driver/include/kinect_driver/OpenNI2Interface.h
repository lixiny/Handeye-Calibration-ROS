        ...
        class RGBCallback : public openni::VideoStream::NewFrameListener
        {
            public:
                ...
                void onNewFrame(openni::VideoStream& stream)
                {
                    ...
                    memcpy((uchar *)_tmp_rgb_image->imageData, (void*)frame.getData(), frame.getWidth() * frame.getHeight() * 3);
        ...
        class DepthCallback : public openni::VideoStream::NewFrameListener
        {
            public:
                DepthCallback(int64_t & lastDepthTime,
                              ...
                              IplImage* tmp_rgb_image, IplImage* rgb_image, IplImage* depth_image)
                ...
                void onNewFrame(openni::VideoStream& stream)
                {
                    ...
                    memcpy((uchar *)_depth_image->imageData, (void*)frame.getData(), frame.getWidth() * frame.getHeight() * 2);
                    ...
                    memcpy((uchar *)_rgb_image->imageData, (uchar *)_tmp_rgb_image->imageData, frame.getWidth() * frame.getHeight() * 3);
